...
const FirmCollections = () => {
  ...
  return (
    <>
      <h3>Restaurants with online food delivery in Kolkata</h3>
      <div className="filterButtons">
        ...
        <button onClick={() => filterHandler("Bakery", 'bakery')} className={activeCategory === 'continental' ? 'activeButton': ''} >Continental</button>
      </div>
